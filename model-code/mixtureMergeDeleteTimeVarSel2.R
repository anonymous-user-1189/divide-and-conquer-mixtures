######
#Implement MerDel with variable selection, clusters selected for merging via correlation, time measured for each 'laps' model, and a laps = 0 simulation. *NO laps = 0 SIMULATION*
