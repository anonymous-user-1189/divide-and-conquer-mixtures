#Frequency of merge/delete Simulation 1.2 - N=2000, P=100, 8 clusters
...
merdelsim2 <- foreach(k = 1:20) %dorng% {
  generation <- GenerateSampleData(2000, 8, c(0.025, 0.025, 0.05, 0.1, 0.1, 0.4, 0.1, 0.2), 100, 0)
  data <- generation[[1]]
...
save(merdelsim2, file="merdelsim2.RData")
