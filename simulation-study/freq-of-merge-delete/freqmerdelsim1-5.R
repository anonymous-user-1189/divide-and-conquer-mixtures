#Frequency of merge/delete Simulation 1.5 - N=1500, P=100, 10 clusters - varsel, 60% rel
...
merdelsim2vs <- foreach(k = 1:20) %dorng% {
  generation <- GenerateSampleData(1500, 10, c(0.05, 0.05, 0.1, 0.1, 0.25, 0.05, 0.1, 0.1, 0.1, 0.1), 60, 40)
  data <- generation[[1]]
...
save(merdelsim2vs, file="merdelsim2vs.RData")
